...
from common.generator import ChunkedGenerator, ChunkedGenerator_Seq

class Fusion(data.Dataset):  #crop:0, downsample:0  pad:0    stride:1
    ...
    def fetch(self, dataset, subjects, subset=1, parse_3d_poses=True):   #self.cameras_train, self.poses_train, self.poses_train_2d
        out_poses_3d = {}
        out_poses_2d = {}
        out_camera_params = {}
